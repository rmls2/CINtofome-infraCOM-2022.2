...
match input_cliente:
    ...
    case '1':
        extensao_arquivo = input(
            'digite a extensão do arquivo que será enviado: ')
        ...
        Cliente().recebe_pacote(socket_cliente,
                                './arqvs_cliente/arquivo_cliente'+extensao_arquivo)
    ...
    case '2':
        ...
        Cliente().envia_pacote(socket_cliente,
                               './arqvs_cliente/arquivo_cliente', Servidor().ip_porta)
        print('\n**pacotes retransmitidos**\n')
